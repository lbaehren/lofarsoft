...
for antenna_set in antenna_sets:
    ...
    for station in stations:
        phasecal = md.getStationPhaseCalibration(station, antenna_set, caltable_location="/Users/pschella/Development/lofar/MAC/Deployment/data/StaticMetaData/CalTables")
