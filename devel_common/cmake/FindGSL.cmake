...
if (NOT FIND_GSL_CMAKE)
  
  set (FIND_GSL_CMAKE TRUE)
  ...
  find_path (GSL_INCLUDES gsl_version.h
    PATHS ${include_locations} /data/sys/opt/gsl/gsl-${GSL_VERSION}/include
    PATH_SUFFIXES gsl
    NO_DEFAULT_PATH
    )
  ...
  find_library (GSL_GSL_LIBRARY gsl
    PATHS ${lib_locations} /data/sys/opt/gsl/gsl-${GSL_VERSION}/lib
    NO_DEFAULT_PATH
    )
