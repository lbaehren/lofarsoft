...
/* $Id: ImportAntenna.h,v 1.3 2006/10/16 13:07:45 huege Exp $*/
...
class ImportAntenna {
  ...
  */
  Bool validData() const { return hasData; }

  /*!
    \brief returns time scale of sampled data (in seconds)
  */
  Double getSamplingTimeScale() const { return itsSamplingTimeScale; }
