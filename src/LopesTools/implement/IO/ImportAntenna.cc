...
Bool ImportAntenna::getTimeSeries(Vector<Double> &Eazimuth, Vector<Double> &Ezenith) const
{
  ...
  {
    cout << "Warning: energy fraction contained in projected pulse for antenna " << getID() << " is only " << projEnergy/fullEnergy << "!\n";
