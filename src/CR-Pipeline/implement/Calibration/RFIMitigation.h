...
/*!
  ...
  <li><em>segmentationVector</em>
      <ul>
      <li><b>gainValues</b> --  Complex spectra of \f$N_{\rm Ant}\f$ array elements with rows equal to 
      number of frequency channels = (dataBlockSize/2)+1 and columns define the number of antennas selected for processing. 
       
       <li><b> dataBlockSize </b> -- Has to be provided by the user, which will define number of frequency channels.
	
       <li><b> nOfSegments </b> -- no of segments in which array of gain curves has to be segmented, default value is 25.
  ...
  <li>We wish to flag regions of RFI. The method applied is to normalize a spectrum
  by dividing it by its underlying gain curve. From this normalized spectrum,
  we are able to easily identify RFI flooded regions. And then deviations from average 
  gaincurves is measured, minimum noise levl has been calculated,
  and for the frequencyindices where RFI is identified that 
  gaincurve values is substituted by the inverse of the normalized gaincurve value. 
  </ol>
*/
