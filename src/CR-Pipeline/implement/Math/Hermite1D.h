...
class Hermite1D {
  ...
  */
  virtual std::vector<double> fx (int const &l,
  ...
  /*!
    ...
    \return y - Values of the Hermite polynomial \f$ H_l (x) \f$.
  */
  virtual std::vector<double> fx (std::vector<int> const &l,
				  std::vector<double> const &x);
  ...
  */
  ...
  /*!
    ...
    \return y - First order derivative of the Hermite polynomial
                \f$ H_l (x) \f$.
  */
  virtual std::vector<double> dfdx (int const &l,
				    std::vector<double> const &x);
  ...
  /*!
    ...
    \return y - First order derivative of the Hermite polynomial
                \f$ H_l (x) \f$.
  */
  virtual std::vector<double> dfdx (std::vector<int> const &l,
				    std::vector<double> const &x);
  ...
  */
  ...
  /*!
    ...
    \return y - Second order derivative of the Hermite polynomial \f$ H_l (x) \f$.
  */
  virtual std::vector<double> d2fdx2 (int const &l,
				 std::vector<double> const &x);
  ...
  /*!
    ...
    \return y - Second order derivative of the Hermite polynomial \f$ H_l (x) \f$.
  */
  virtual std::vector<double> d2fdx2 (std::vector<int> const &l,
				      std::vector<double> const &x);
