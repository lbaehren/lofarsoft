...
namespace CR {  // Namespace CR -- BEGIN
  ...
  void Shapelets1D::calcCoefficients ()
  {
    ...
    coefficients_p.resize(nofCoeff_p);
  ...
  Array<double,1> Shapelets1D::fx (int const &l,
				   Array<double,1> const &x)
  {
    unsigned int nelem (x.numElements());
  ...
  Array<double,1> Shapelets1D::fx (Array<int,1> const &l,
				   Array<double,1> const &x)
  {
  ...
  Array<double,1> Shapelets1D::dfdx (int const &l,
				     Array<double,1> const &x)
  {
    int nelem (x.numElements());
    Array<double,1> y (nelem);
  ...
  Array<double,1> Shapelets1D::dfdx (Array<int,1> const &l,
				     Array<double,1> const &x)
  {
    int nelem (x.numElements());
    Array<double,1> y (nelem);
