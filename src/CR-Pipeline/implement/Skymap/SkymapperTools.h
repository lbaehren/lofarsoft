...
class SkymapperTools {
  ...
  */
  ...
  /*!
    ...
    \param obsinfo        -- Observation information (epoch, location, ...)
  ...
  */
  ...
  /*!
    ...
    \param glishRec -- Another coordinate system object embedded in a GlishRecord

    \return csys -- Coordinate system associated with the image
  */
  static CoordinateSystem coordinateSystem (GlishRecord const &glishRec);
