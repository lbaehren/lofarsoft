...
void script_new()
{
    ...
    gROOT->LoadMacro("/home/stijnbui/numoon/new_analysis.C+");
    
    //analyses_final_v20(TEC,110.0,120.0,70.0,60.0,1.4,1.5,1.5,1.5,1.2,1.4,1.2,1.2);
    analyses_new_v20(TEC,10.0,10.0,10.0,10.0);
