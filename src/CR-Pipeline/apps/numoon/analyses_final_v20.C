...
void analyses_final_v20(Double_t TEC = 0.0, Double_t Threshold0 = 120.0, Double_t Threshold1 = 120.0, Double_t Threshold2 = 120.0, Double_t Threshold3 = 120.0, Double_t gain_gate_x_0 = 1.20, Double_t gain_gate_y_0 = 1.20, Double_t gain_gate_x_1 = 1.20, Double_t gain_gate_y_1 = 1.20, Double_t gain_gate_x_2 = 1.20, Double_t gain_gate_y_2 = 1.20, Double_t gain_gate_x_3 = 1.20, Double_t gain_gate_y_3 = 1.20)
{
  ...
  sprintf(inFileName0, "/raid/pv2/numoon/freq1.data");
  sprintf(inFileName1, "/raid/pv2/numoon/freq2.data");
  sprintf(inFileName2, "/raid/pv2/numoon/freq3.data");
  sprintf(inFileName3, "/raid/pv2/numoon/freq4.data");
  ...
  sprintf(outFileName0, "/raid/pv2/numoon/output/dada.output.1");
  sprintf(outFileName1, "/raid/pv2/numoon/output/dada.output.2");
  sprintf(outFileName2, "/raid/pv2/numoon/output/dada.output.3");
  sprintf(outFileName3, "/raid/pv2/numoon/output/dada.output.4");
  sprintf(outFileName4, "/raid/pv2/numoon/output/dada.time.output");
