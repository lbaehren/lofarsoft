...
evmeta.ch['20101'].AntennaCalFile := 'lopes10-alteich.tab';
evmeta.ch['20102'].AntPos := '68.283 ,45.522  ,124.507'; #C14Q3 #pos10
evmeta.ch['20102'].ClusterPos := 'Cluster 14 Quadrant 3  ';
evmeta.ch['20102'].AntennaCalFile := 'lopes10-alteich.tab';
