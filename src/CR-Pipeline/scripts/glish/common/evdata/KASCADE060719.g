...
#
# valid since: 2006/07/19/00:00:00
...
evmeta.ch['80201'].AntPos := '-7.836,-127.748,125.980'; #WO-NS
evmeta.ch['80201'].ClusterPos := 'Wiese Osten NS-pol';
...
evmeta.ch['90101'].AntPos := '-13.871,-97.969,126.171'; #C5Q1-NS
evmeta.ch['90101'].ClusterPos := 'Cluster5  Quadrant 1 NS-pol';
evmeta.ch['90101'].AntennaCalFile := 'empty.tab';
evmeta.ch['90101'].TIMoffset := 0;

evmeta.ch['90102'].AntPos := '4.325,-66.075,126.161'; #C5Q3-NS
evmeta.ch['90102'].ClusterPos := 'Cluster 5 Quadrant 3 NS-pol';
