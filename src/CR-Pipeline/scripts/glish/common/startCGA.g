...
#-------------------------------------------------------------------------------
# $Id: startCGA.g,v 1.1 2007/07/26 14:37:22 horneff Exp $
#-------------------------------------------------------------------------------
#
...
include add_dir('data-CGaccess.g');
...
if (!is_defined('data')) {
  ...
  input_CGA_event(data,'/data/LOPES/cr/LOPES30_sel/2005.11.01.08:20:35.004.event');
} else {
