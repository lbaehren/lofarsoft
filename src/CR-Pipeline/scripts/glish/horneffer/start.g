...
#-------------------------------------------------------------------------------
# $Id: start.g,v 1.1 2006/03/06 15:37:01 horneff Exp $
#-------------------------------------------------------------------------------
#
...
if (has_field(environ,'LOPESCODEDIR')){
  ...
  include spaste(environ.LOPESCODEDIR,'/globals-const.g');
...
include add_dir('tBeamformer.g');
include add_dir('tSkymapper.g');
include add_dir('itsform.g');
...
if (fexist(globalconst.MyStart)) {include globalconst.MyStart};
...
print "CodeDir ..... : ",globalconst.CodeDir;
print "progDir ..... : ",globalconst.progDir;
print "MyStart ..... : ",globalconst.MyStart;
print "DAQcprogDir . : ",globalconst.DAQcprogDir;
print "cprogDir .... : ",globalconst.cprogDir;
...
print "relgainfile . : ",globalpar.relgainfile;
...
if ((!is_defined('plotgui')) && globalpar.LOPESGUI) gui();
else {};
