...
ccc        call pgvport(vport(1),vport(2),vport(3),vport(4))
ccc        call pgwindow(blc(1)-0.5,trc(1)+0.5,blc(2)-0.5,trc(2)+0.5)
ccc        call pgbox('BCINST',0.0,0,'BICNST',0.0,0)
ccc        call pgcurs(xcur,ycur,ch11)
ccc        call pgband(2,1,xcur,ycur,xcur1,ycur1,ch11)
...
ccc        call pgband(6,1,mn1,mn2,xcur1,ycur1,ch11)
ccc        call pgmove(xcur1,mn2)
ccc        call pgdraw(xcur1,mx2)
ccc        call pgband(6,1,mn1,mn2,xcur2,ycur1,ch11)
ccc        call pgmove(xcur2,mn2)
ccc        call pgdraw(xcur2,mx2)
        low=min(xcur1,xcur2)
        up=max(xcur1,xcur2)
        chold=ch1
...
ccc        call pgtext(blc(1)+0.2*(trc(1)-blc(1)),trc(2)+0.05*(trc(2)-
 
ccc        call pgcurs(xcur,ycur,chr)
