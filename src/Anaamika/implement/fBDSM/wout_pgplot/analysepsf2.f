...
ccc        call pgvport(0.15,0.9,0.15,0.9)
ccc        call pgwindow(mnx,mxx,mny,mxy)
ccc        call pgbox('BCNST',0.0,0,'BCNST',0.0,0)
        do i=1,ng
         dum4=ebmaj(i)
ccc         call pgpoint(1,x4(i),y4j(i),3)
ccc         call pgerry(1,x4(i),y4j(i)+dum4,y4j(i)-dum4,1.0)
        end do
ccc        call pglabel('log10(SNR)','B_major','')
ccc        call pgsci(2)
ccc        call pgline(100,sm_snr4,sm_ebj4)
ccc        call pgsci(3)
ccc        call pgline(nbin,x4d,y4d)
ccc        call pgsci(4)
ccc        call pgpoint(nbin,x4d,y4d,17)
ccc        call pgsci(1)
