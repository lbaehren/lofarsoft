...
ccc          call pgscr(i,red,green,blue)
         end do
        end if
...
ccc         call pgscir(clr1,clr2)
         do i=clr1,clr2
          ...
          j=int(indx)
ccc          call pgscr(i,slsr(j),slsg(j),slsb(i))
         end do
        end if
...
ccc          if (i.ge.clr1.and.i.le.clr2) call pgscr(j,red,green,blue)
         end do
         close(21)
        else
         open(unit=21,file='pg_greyscale',status='old')
         do i=1,99-clr2
          read (21,*) j,red,green,blue
ccc          call pgscr(clr2+1+j,red,green,blue)
         end do
         close(21)
        end if
