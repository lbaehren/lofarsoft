...
ccc        call pgwindow(-0.5,cross*1.0,mn*0.9,mx*1.1)
ccc        call pgmove(-0.5,0.0)
ccc        call pgdraw(j*1.0,0.0)
ccc        call pgbox('BNST',0.0,0,'BCNVST',0.0,0)
ccc        call pgpoint(k,ex,why,17)
ccc        call pgtext(0.4*j,mx-0.3*(mx-mn),'Diagonal slice plot')
ccc        call pgend
