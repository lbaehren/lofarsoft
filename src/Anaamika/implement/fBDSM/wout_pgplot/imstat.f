...
ccc         call pghist(i,image,mn4,mx4,nbin,0)
ccc         call pgqwin(mn41,mx41,mn42,mx42)
ccc         call pgend

ccc         call pgbegin(0,'/xs',1,1)
ccc         call pgvport(0.1,0.9,0.3,0.9)
         dum4=a(1)*1.1
ccc         call pgwindow(mn41,mx41,mn42,dum4)
ccc         call pgbox('BCNST',0.0,0,'BCNST',0.0,0)
ccc         call pghist(i,image,mn4,mx4,nbin,1)
ccc         call pgsls(2)
...
ccc	 call pgwindow(mn4,mx4,mn41,mx41)
