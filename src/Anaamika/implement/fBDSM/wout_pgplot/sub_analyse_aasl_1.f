...
ccc        call pgvport(0.10,0.60,0.51,0.99)
c         mny=-5.22
c         mxy=9.82
c        mny= 0.1
c        mxy= 4.0
...
ccc        call pgbox(boxx(1:nchar(boxx)),0.0,0,boxy(1:nchar(boxy)),0.0,0)
ccc        call pglabel(xlab(1:nchar(xlab)),ylab(1:nchar(ylab)),' ')
ccc        call pgpoint(n,xplot4,yplot4,3)
ccc        call pgsci(2)
ccc        call pgmove(mnx,base4)
ccc        call pgdraw(mxx,base4)
ccc        call pgsci(1)
...
ccc        call pgsci(3)
ccc        call pgpoint(nbin,x4,y4,3)
ccc        call pgline(nbin,x4,y4)
ccc        call pgsci(4)
ccc        call pgpoint(nbin,x4,y41,3)
ccc        call pgline(nbin,x4,y41)
ccc        call pgpoint(nbin,x4,y42,3)
ccc        call pgline(nbin,x4,y42)
ccc        call pgsci(1)
