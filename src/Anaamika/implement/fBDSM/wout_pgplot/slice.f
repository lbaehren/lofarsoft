...
444     continue
ccc        call pgvport(0.1,1.0,0.3,1.0)
        call sub_basicgrey(n,m,av,std,low,up,arr4,lab)

ccc        call pgvport(0.1,1.0,0.1,1.0)
ccc        call pgwindow(0.0,1.0,0.0,1.0)
ccc        call pgtext(0.1,0.97,'Click on pixel or '//
 

ccc        call pgvport(0.1,1.0,0.3,1.0)
ccc        call pgwindow(0.5,n+0.5,0.5,m+0.5)
ccc        call pgcurs(xcur,ycur,str12)
...
ccc         call pgeras
ccc         call pgvport(0.1,1.0,0.1,0.3)
ccc         call pgwindow(0.0,yr*1.0,mn,mx)
ccc         call pgbox('BCNST',0.0,0,'BCNST',0.0,0)
ccc         call pgline(yr,x4,y4)
