...
c! modified for extra mask instead of cutoff.
        SUBROUTINE mrqmin2dm(y,mask,sig,ndata,mdata,a,ia,ma,
...
11        continue
          alamda=0.001
          call mrqcof2dm(y,mask,sig,ndata,mdata,a,ia,ma,alpha,
     /                  beta,nca,chisq,fnum)
          ochisq=chisq
          do 12 j=1,ma
            atry(j)=a(j)
...
15      continue
        call mrqcof2dm(y,mask,sig,ndata,mdata,atry,ia,ma,covar,
     /                da,nca,chisq,fnum)
