...
c! naxis=2 makes wcsini reset variables in previous program for gfortran-64bit
...
c        real*8 pc(2,2),crot
c        character ctype(2)*72
c        real*8 crpix(2),cdelt(2),crval(2),crota(2)
        real*8 pc(3,3),crot
        character ctype(3)*72
