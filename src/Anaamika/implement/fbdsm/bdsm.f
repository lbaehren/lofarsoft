...
c! test psf vriation prog here for now
c         imagename=filename(1:nchar(filename))//'.'//
c     /      solnname(1:nchar(solnname))//'.ch0'
c         call call_psf_analyse(scratch,srldir,fullname,imagename,
c     /           plotdir,runcode,n,m,l,l0,filename)
