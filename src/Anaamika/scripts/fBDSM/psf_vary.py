...
scratch = "/Users/mohan/anaamika/image/"
fitsdir = "/Users/mohan/anaamika/fits/"
plotdir = "/Users/mohan/anaamika/plots/"
srldir = "/Users/mohan/anaamika/image/"
runcode = "mv"
...
# prepare list of good tiles to pass to pixintile
    ...
    for itile in range(new_n):
        tile_gauls = [n for n in tr if r2t[volrank[int(round(n[11])),int(round(n[13]))]-1] \
			== itile]
        ngenpertile[itile]=len(tile_gauls)
...
def psf_in_tile(image, beam, g_gauls, flag_unresolved, cdelt, factor, snrcutstack, volrank, \
    ...
    if plot: 
      ...
      pl.savefig(pname + "tesselatedimage.png")
...
fitsfilename='3c61_restored_115-185MHz.fits'
fitsfilename='cg.fits'
fitsfilename='mi_spam_new.fits'  # beam is ellipse
...
ltnum=1
ngenpertile, tile_prop, r2t = edit_tile(ltnum, g_gauls, flag_unresolved, snrcutstack, volrank, \
...
psfimages, psfcoords, totpsfimage = psf_in_tile(image, beam, g_gauls, flag_unresolved, \
           cdelt, factor, snrcutstack, volrank, tile_prop, r2t, plot_psfintile)
