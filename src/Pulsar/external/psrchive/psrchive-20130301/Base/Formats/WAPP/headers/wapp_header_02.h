/* 
  RCS: $Id: wapp_header_02.h,v 1.1 2008/01/17 20:59:40 demorest Exp $
...
*/
    ...
    double coeff[144];     /* polynomial coefficients calculated by TEMPO effectively [9][16] */
    int32_t num_coeffs[9];     /* number of coefficients */

    char filler[324];      /* this pads out the header to 2048 bytes */
