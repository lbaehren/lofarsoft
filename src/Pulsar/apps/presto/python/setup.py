...
undef_macros = []
extra_compile_args = []
include_dirs = ["/Users/lars/CodeDevelopment/Projects/Work/lofarsoft/release/share/pulsar/include", "/opt/local/include"]
#library_dirs = ["/Users/lars/CodeDevelopment/Projects/Work/lofarsoft/release/share/pulsar/lib", "/opt/local/lib"]
library_dirs = []

#ppgplot_libraries = ["cpgplot", "pgplot", "X11", "png", "m", "g2c"]
ppgplot_libraries = ["cpgplot", "pgplot", "X11", "png", "m"]
ppgplot_library_dirs = ["/opt/local/lib"]

presto_libraries = ["presto", "fftw3f", "m"]
presto_library_dirs = ["/Users/lars/CodeDevelopment/Projects/Work/lofarsoft/release/share/pulsar/lib"]
