...
c=============================================================================
	...
	integer length,nsrec,nchan,nread,seed,norg,nmax,ihour
 	integer readsample,skipsample,readpsample
	character*80 pfile
	real f0,chbw
	...
	save
c=============================================================================
        if (index(filename,'.inf').gt.0) then
          header=' '
          refac=0.0
          nchans=1
          write(llog,*) 'Working with Presto time series data...'
	  write(llog,*) 'Reading header'
          call readphd(filename,tmpdm,rtsamp)
          write(llog,*) 'Read header'
