...
\verb|${LOFARSOFT}/src/Pulsar/pipeline/documentation|. This document
is delivered and appears in the top level of the Pulp distribution,
with build materiel located in the documentation directory. 
...
-rw-r--r--   1 <user>    staff  315325 Feb  2 20:00 pulpUserGuide.pdf
...
browser)\footnote{Illustration of an obvious need for a PulpPipeline()
 base class that would supply the python-private ``buildUserEnv()'' method.
 However, once the PulpEnv() call is moved the master recipes, this
 method will be deprecated and expunged.}
