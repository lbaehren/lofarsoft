...
if len(sys.argv) < 7 or len(sys.argv) > 10:
	...
	print "\t<> required"
	print "\t E.g., amplitude_difference.py /lifs006/SB3.MS 1 3 8 13 0 channel 3 6"
	...
	print "\t-1 means plot all.  Default plots the amplitude difference of the xx for all channels as function of time."
...
if (range_plot != -1):
	if quantity_plot == 'channel':
		...
		subplot(212)
		plot( time, ampl12[:,range_plot], "," ,time, ampl34[:,range_plot], ",")
		if pol2:  plot( time, ampl12_2[:,range_plot], "," ,time, ampl34_2[:,range_plot], ",")
		xlabel("Time (s)")
		ylabel("Amplitude")
		...
		subplot(212)
		plot( ampl12[range_plot,:], "," , ampl34[range_plot,:], ",")
		if pol2:  plot( ampl12_2[range_plot,:], "," , ampl34_2[range_plot,:], ",")
		xlabel("Channel")
		ylabel("Amplitude")
