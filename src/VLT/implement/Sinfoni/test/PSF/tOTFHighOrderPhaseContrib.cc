//#  tOTFHighOrderPhaseContrib.cc: Test program for the
//#                                OTFHighOrderPhaseContrib class.
//#
...
//#
//#  $Id: tOTFHighOrderPhaseContrib.cc,v 1.4 2006/05/19 16:03:24 loose Exp $
...
int main()
{
  try {
    ...
    cout << setprecision(8) 
         << theOTFHighOrderPhaseContrib(theApertureToFriedRatio())
         << endl;
  }
  catch (Exception& e) {
    cerr << e << endl;
