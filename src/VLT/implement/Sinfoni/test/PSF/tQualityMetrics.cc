//#  QualityMetrics.cc: Test program for the QualityMetrics class.
//#
...
//#
//#  $Id: tQualityMetrics.cc,v 1.3 2006/05/19 16:03:24 loose Exp $
...
int main()
{
  try {
    ...
    cout << setprecision(8) << theQualityMetrics() << endl;
  } 
