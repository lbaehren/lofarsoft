//#  tApertureToFriedRatio.cc: Test program for the ApertureToFriedRatio class.
//#
...
//#
//#  $Id: tApertureToFriedRatio.cc,v 1.4 2006/05/19 16:03:24 loose Exp $
...
int main()
{
  try {
    ...
    cout << setprecision(8) << theApertureToFriedRatio() << endl;
  } catch (Exception& e) {
    cerr << e << endl;
    return 1;
  }
