//#  tModalCoordResidualPhase.cc: Test program for the ModalCoordResidualPhase
//#                               class.
//#
...
//#
//#  $Id: tModalCoordResidualPhase.cc,v 1.4 2006/05/19 16:03:24 loose Exp $
...
int main()
{
  try {
    ...
    cout << setprecision(8) << theModalCoordResidualPhase().covariance() 
         << endl;
  }
  catch (Exception& e) {
    cerr << e << endl;
