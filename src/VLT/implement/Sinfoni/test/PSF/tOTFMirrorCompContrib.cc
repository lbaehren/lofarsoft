//#  tOTFMirrorCompContrib.cc: Test program for the OTFMirrorCompContrib class.
//#
...
//#
//#  $Id: tOTFMirrorCompContrib.cc,v 1.4 2006/05/19 16:03:24 loose Exp $
...
int main()
{
  try {
    ...
    cout << setprecision(8) << theOTFMirrorCompContrib() << endl;
  }
  catch (Exception& e) {
    cerr << e << endl;
    return 1;
