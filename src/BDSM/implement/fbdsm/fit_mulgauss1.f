c! fits multiple gaussians. modified from ../shapelets/program
        ...
        subroutine fit_mulgauss1(subim,subrms,subn,subm,mask,
     ...
     /      e_maj,e_min,e_pa,e_d1,e_d2,e_d3,e_tot,minpix_isl,nnc)
        ...
        real*8 e_tot(max_msrc),minpix_isl
...
555     continue
        ...
        alamda=-1.d0
        dumi1=nmulsrc*6
334     call callmrqmin2dm(dumi1,subim,mask,sig,subn,subm,a,ia,nmul6,
     /        covar,alpha,nmul6,chisq,alamda,2)
        write (nnc,'(e11.4,$)') chisq
     ...
     /        covar,alpha,nmul6,chisq,alamda,2)
        write (nnc,'(e11.4,$)') chisq
        write (nnc,'(e11.4,$)') 9.9090d90  ! seperator
