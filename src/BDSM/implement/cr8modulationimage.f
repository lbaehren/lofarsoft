c! create image of modulation on noise by adding 3 sine waves
        ...
        subroutine cr8modulationimage(filen,n,m,seed,scratch)
        implicit none
        integer i,n,m,seed,j,nchar
        character filen*(*),strdev*5,lab*500,extn*10,f1*500
...
130      continue
120     continue
        call writearray_bin(modl,n,m,n,m,filen,'mv')

        write (*,'(a34,$)') '   Image of modulations ... <RET> '
        read (*,*)
        lab='Image of modulation on noise'
        call grey(modl,n,m,n,m,strdev,lab,0,1,'hn',1,scratch)
