c!
        ...
        subroutine read_qcparadefine(error1,fitsdir,scratch,srldir,
     /             fitsname,solnname,qcsolnname,runcode,plotdir)
        implicit none
        character fitsdir*500,scratch*500,fitsname*500,srldir*500
        character fg*500,extn*20,keyword*500,comment*500,dir*500
        character solnname*500,runcode*2,dums*500,qcsolnname*500
        ...
        error1=0
        inquire(file='qcparadefine',exist=ex)
        if (.not.ex) then
         write (*,*) '  File "qcparadefine" not found.'
         error1=1
         goto 444
        end if
     ...
     /       comment,'s',dir,error)
        keyword='qcsolnname'
        call get_keyword(fg,extn,keyword,qcsolnname,keyvalue,
     /       comment,'s',dir,error)
        keyword='runcode'
