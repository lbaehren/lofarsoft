#ifndef DEF_STOCK_WRITE_ROOT_METADATA_STANDALONE
#define DEF_STOCK_WRITE_ROOT_METADATA_STANDALONE
...
class Stock_Write_Root_Metadata_Standalone
{  
  // Public Methods
  public:
  
    Stock_Write_Root_Metadata_Standalone();
    ~Stock_Write_Root_Metadata_Standalone();
