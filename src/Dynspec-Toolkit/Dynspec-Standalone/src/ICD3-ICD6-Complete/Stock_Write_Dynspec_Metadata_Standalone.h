#ifndef DEF_STOCK_WRITE_DYNSPEC_METADATA_STANDALONE
#define DEF_STOCK_WRITE_DYNSPEC_METADATA_STANDALONE
...
/// \class Stock_Write_Dynspec_Metadata_Standalone
...
{  
  ...
  public:
    ...
    Stock_Write_Dynspec_Metadata_Standalone();
    ~Stock_Write_Dynspec_Metadata_Standalone();
    ...
    void writeDynspecMetadata(Group &dynspec_grp,std::string obsName,std::string pathFile,std::string outputFile,File &root_grp,int i,int j,int k,int l,int obsNofStockes,std::vector<std::string> stokesComponent,
			      float memoryRAM);
