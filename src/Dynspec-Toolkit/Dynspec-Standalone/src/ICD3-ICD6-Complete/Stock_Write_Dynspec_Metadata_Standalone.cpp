...
/// \file Stock_Write_Dynspec_Metadata_Standalone.cpp
///  \brief File C++ (associated to Stock_Write_Dynspec_Metadata_Standalone.h) for stock and write metadatas for the ICD6's Dynspec Groups 
///  \details  
/// <br /> Overview:
...
using namespace std;
  ...
  Stock_Write_Dynspec_Metadata_Standalone::Stock_Write_Dynspec_Metadata_Standalone(){}
  Stock_Write_Dynspec_Metadata_Standalone::~Stock_Write_Dynspec_Metadata_Standalone(){}


  void Stock_Write_Dynspec_Metadata_Standalone::stockDynspecMetadata(string attr_69,string attr_70,string attr_71,string attr_72,string attr_73,double attr_76,double attr_77,string attr_78,string attr_79,
...
/// <br /> Usage:
/// <br />    void Stock_Write_Dynspec_Metadata_Standalone::stockDynspecMetadata(string attr_69,string attr_70,string attr_71,string attr_72,string attr_73,double attr_76,double attr_77,string attr_78,string attr_79,
/// string attr_80,double attr_81,double attr_82,double attr_83,double attr_84,double attr_85,double attr_86,double attr_87,double attr_88,double attr_89,
/// string attr_90,double attr_91,vector<string> attr_92,string attr_93,double attr_94,string attr_95,bool attr_96,vector<string> attr_97,bool attr_98,string attr_99,
/// string attr_100,vector<double> attr_101,vector<string> attr_102,string attr_103,double attr_104,string attr_105,string attr_106,double attr_107,double attr_108,vector<string> attr_109,
/// string attr_110,string attr_111,vector<string> attr_112,int attr_113,vector<string> attr_114,vector<string> attr_115,vector<double> attr_116,vector<double> attr_117,vector<double> attr_118,
...
////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  void Stock_Write_Dynspec_Metadata_Standalone::writeDynspecMetadata(Group &dynspec_grp,string obsName,string pathFile,string outputFile,File &root_grp,int i,int j,int k,int l,int obsNofStockes,vector<string> stokesComponent,float memoryRAM)
  {

    
/// <br /> Usage:
/// <br />   void Stock_Write_Dynspec_Metadata_Standalone::writeDynspecMetadata(Group &dynspec_grp,string pathDir,string obsName,string pathFile,string outputFile,File &root_grp,int i,int j,int k,int l,int q,int obsNofStockes,vector<string> stokesComponent,float memoryRAM)
