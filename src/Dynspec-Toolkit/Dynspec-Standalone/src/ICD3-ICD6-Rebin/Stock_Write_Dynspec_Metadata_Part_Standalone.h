#ifndef DEF_STOCK_WRITE_DYNSPEC_METADATA_PART_STANDALONE
#define DEF_STOCK_WRITE_DYNSPEC_METADATA_PART_STANDALONE
...
/// \class Stock_Write_Dynspec_Metadata_Part_Standalone
...
{  
  ...
  public:
    ...
    Stock_Write_Dynspec_Metadata_Part_Standalone();
    ~Stock_Write_Dynspec_Metadata_Part_Standalone();


    void stockDynspecMetadata(std::string attr_69,std::string attr_70,std::string attr_71,std::string attr_72,std::string attr_73,double attr_76,double attr_77,std::string attr_78,std::string attr_79,
    ...
    void writeDynspecMetadata(Group &dynspec_grp,std::string obsName,std::string pathFile,std::string outputFile,File &root_grp,int i,int j,int k,int obsNofStockes,std::vector<std::string> stokesComponent,
			      float memoryRAM);
