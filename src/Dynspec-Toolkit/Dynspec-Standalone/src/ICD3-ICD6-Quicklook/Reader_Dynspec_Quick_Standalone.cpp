...
/// \file Reader_Dynspec_Quick_Standalone.cpp
///  \brief File C++ (associated to Reader_Dynspec_Quick_Standalone.h)for read ICD3 files and put in variables metadatas for the ICD6's Dynspec Group  
///  \details  
/// <br /> Overview:
/// <br /> This function readDynspec is described (programmed) here. It needs as parameter a Stock_Write_Dynspec_Metadata_Quick_Standalone object. The readDynspec function will read 
///  dynspec metadatas and stock them in the Stock_Write_Dynspec_Metadata_Quick_Standalone object as private attributes thanks to stockDynspecMetadata function.
///  These attributes will be written in the next step by writeDynspecMetadata function which is in the class 
///  Stock_Write_Dynspec_Metadata_Quick_Standalone.h  and called at the end of this Reader_Dynspec_Quick_Standalone.cpp
...
using namespace std;
  ...
  Reader_Dynspec_Quick_Standalone::Reader_Dynspec_Quick_Standalone(){}	// constructor 
  Reader_Dynspec_Quick_Standalone::~Reader_Dynspec_Quick_Standalone(){}	// destructor
...
/// \return boolean value 
  ...
  void Reader_Dynspec_Quick_Standalone::readDynspec(string pathFile,Stock_Write_Dynspec_Metadata_Quick_Standalone *dynspecMetadata,Stock_Write_Dynspec_Data_Quick_Standalone *dynspecData,int i,int j,int obsNofSAP,int obsNofStockes,vector<string> stokesComponent,float timeMinSelect,float timeMaxSelect,float timeRebin,float frequencyMin,float frequencyMax,float frequencyRebin)
    {        
       
  
/// <br /> Usage:
/// <br />   void Reader_Dynspec_Quick_Standalone::readDynspec(string pathFile,Stock_Write_Dynspec_Metadata_Quick_Standalone *dynspecMetadata,Stock_Write_Dynspec_Data_Quick_Standalone *dynspecData,int i,int j,int q,int obsNofSAP,int obsNofSource,int obsNofFrequencyBand,int obsNofStockes,vector<string> stokesComponent, int SAPindex,float timeMinSelect,float timeMaxSelect,float timeRebin,float frequencyMin,float frequencyMax,float frequencyRebin)
 
/// \param  pathFile  ICD3 file to read 
/// \param  *dynspecMetadata Reader_Dynspec_Quick_Standalone Object for loading dynspec metadata in private attributes
/// \param  *dynspecData Stock_Write_Dynspec_Data_Quick_Standalone Object for loading new rebinning for data matrix processing 
