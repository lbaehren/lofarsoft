...
/// \file Reader_Root_Quick_Standalone.cpp
///  \brief File C++ (associated to Reader_Root_Quick_Standalone.h) for read ICD3 files and put in variables metadatas for the ICD6's Root Group  
///  \details  
/// <br /> Overview:
/// <br /> This function readRoot is described (programmed) here. It needs as parameter a Stock_Write_Root_Metadata_Quick_Standalone object. The readRoot function will read 
///  root metadatas and stock them in the Stock_Write_Root_Metadata_Quick_Standalone object as private attributes thanks to stockRootMetadata function.
///  These attributes will be written in the next step by writeRootMetadata function which is in the class 
///  Stock_Write_Root_Metadata_Quick_Standalone.h  and called at the end of this Reader_Root_Quick_Standalone.cpp
...
using namespace std;
  ...
  Reader_Root_Quick_Standalone::Reader_Root_Quick_Standalone(){}	// constructor 
  Reader_Root_Quick_Standalone::~Reader_Root_Quick_Standalone(){}	// destructor
  

    
  void Reader_Root_Quick_Standalone::readRoot(string pathFile,string obsName,Stock_Write_Root_Metadata_Quick_Standalone *rootMetadata,int obsNofBeam,float timeMinSelect,float timeMaxSelect,float timeRebin,float frequencyMin,float frequencyMax,float frequencyRebin)

  { 
    
/// <br /> Usage:
/// <br /> void Reader_Root_Quick_Standalone::readRoot(string pathFile,string obsName,Stock_Write_Root_Metadata_Quick_Standalone *rootMetadata,int obsNofSource,int obsNofBeam,int obsNofFrequencyBand,int obsNofTiledDynspec, string SAPname, int SAPindex,float timeMinSelect,float timeMaxSelect,float timeRebin,float frequencyMin,float frequencyMax,float frequencyRebin)

 
/// \param pathFileICD3 file to read
/// \param obsName observation ID
/// \param *rootMetadata Stock_Write_Root_Metadata_Quick_Standalone class object
