#ifndef DEF_STOCK_WRITE_DYNSPEC_METADATA_PART
#define DEF_STOCK_WRITE_DYNSPEC_METADATA_PART
...
/// \class Stock_Write_Dynspec_Metadata_Quick_Standalone
...
{  
  ...
  public:
    ...
    Stock_Write_Dynspec_Metadata_Quick_Standalone();
    ~Stock_Write_Dynspec_Metadata_Quick_Standalone();
