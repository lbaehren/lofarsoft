#ifndef DEF_STOCK_WRITE_ROOT_METADATA_PART_STANDALONE
#define DEF_STOCK_WRITE_ROOT_METADATA_PART_STANDALONE
...
/// \class Stock_Write_Root_Metadata_Quick_Standalone
...
{  
  ...
  public:
    ...
    Stock_Write_Root_Metadata_Quick_Standalone();
    ~Stock_Write_Root_Metadata_Quick_Standalone();
