...
{  
  ...
  void readRoot(std::string pathFile,std::string obsName,Stock_Write_Root_Metadata *rootMetadata,int obsNofBeam,int obsNofFrequencyBand,int obsNofTiledDynspec, std::string SAPname, int SAPindex);
