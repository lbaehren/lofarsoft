#ifndef DEF_STOCK_WRITE_ROOT_METADATA_PART
#define DEF_STOCK_WRITE_ROOT_METADATA_PART
...
/// \class Stock_Write_Root_Metadata_Quick
...
{  
  ...
  public:
    ...
    Stock_Write_Root_Metadata_Quick();
    ~Stock_Write_Root_Metadata_Quick();
