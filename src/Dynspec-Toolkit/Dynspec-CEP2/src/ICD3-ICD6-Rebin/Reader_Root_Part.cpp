...
using namespace std;
  ...
  void Reader_Root_Part::readRoot(string pathFile,string obsName,Stock_Write_Root_Metadata_Part *rootMetadata,int obsNofBeam,int obsNofFrequencyBand,int obsNofTiledDynspec, string SAPname, int SAPindex,float timeMinSelect,float timeMaxSelect,float timeRebin,float frequencyMin,float frequencyMax,float frequencyRebin)
