#ifndef DEF_STOCK_WRITE_ROOT_METADATA_PARTIONNED
#define DEF_STOCK_WRITE_ROOT_METADATA_PARTIONNED
...
/// \class Stock_Write_Root_Metadata_Partionned
...
{  
  ...
  public:
    ...
    Stock_Write_Root_Metadata_Partionned();
    ~Stock_Write_Root_Metadata_Partionned();


    void stockRootMetadataPartionned(std::string attr_1,std::string attr_2,std::string attr_3,std::string attr_4,std::string attr_5,std::string attr_7,std::string attr_8,std::string attr_9,std::string attr_10,
    ...
    void writeRootMetadataPartionned(std::string outputFile,File &root_grp);
