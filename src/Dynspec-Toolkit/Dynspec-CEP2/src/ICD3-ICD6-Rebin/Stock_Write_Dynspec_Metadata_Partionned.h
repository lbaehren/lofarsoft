#ifndef DEF_STOCK_WRITE_DYNSPEC_METADATA_PARTIONNED
#define DEF_STOCK_WRITE_DYNSPEC_METADATA_PARTIONNED
...
/// \class Stock_Write_Dynspec_Metadata_Part
///  \brief Class object for stocking and writting metadatas for the ICD6's Dynspec Groups (loop on Beams ...) 
///  \details  
/// <br /> Usage: 
...
class Stock_Write_Dynspec_Metadata_Partionned
{  
  // Public Methods
  public:
  
    Stock_Write_Dynspec_Metadata_Partionned();
    ~Stock_Write_Dynspec_Metadata_Partionned();


    void stockDynspecMetadataPartionned(std::string attr_69,std::string attr_70,std::string attr_71,std::string attr_72,std::string attr_73,double attr_76,double attr_77,std::string attr_78,std::string attr_79,
    ...
    void writeDynspecMetadataPartionned(Group &dynspec_grp,std::string obsName,std::string pathFile,std::string outputFile,File &root_grp,int i,int j,int k,int l,int q,int obsNofStockes,std::vector<std::string> stokesComponent,
			      float memoryRAM);
