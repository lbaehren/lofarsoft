#ifndef DEF_STOCK_WRITE_DYNSPEC_METADATA_LINEAR_POLAR
#define DEF_STOCK_WRITE_DYNSPEC_METADATA_LINEAR_POLAR
...
/// \class Stock_Write_Dynspec_Metadata_Linear_Polar
...
{  
  ...
  public:
    ...
    Stock_Write_Dynspec_Metadata_Linear_Polar();
    ~Stock_Write_Dynspec_Metadata_Linear_Polar();
