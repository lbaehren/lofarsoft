...
/// \file Stock_Write_Root_Metadata_Linear_Polar.cpp
///  \brief File C++ (associated to Stock_Write_Root_Metadata_Linear_Polar.h) for stock and write metadatas for the ICD6's Root Group 
///  \details  
/// <br /> Overview:
...
using namespace std;
  ...
  Stock_Write_Root_Metadata_Linear_Polar::Stock_Write_Root_Metadata_Linear_Polar(){}
  Stock_Write_Root_Metadata_Linear_Polar::~Stock_Write_Root_Metadata_Linear_Polar(){}


  void Stock_Write_Root_Metadata_Linear_Polar::stockRootMetadata(string attr_1,string attr_2,string attr_3,string attr_4,string attr_5,string attr_7,string attr_8,string attr_9,string attr_10,
...
/// <br /> Usage:
/// <br />   void Stock_Write_Root_Metadata_Linear_Polar::stockRootMetadata(string attr_1,string attr_2,string attr_3,string attr_4,string attr_5,string attr_7,string attr_8,string attr_9,string attr_10,
/// string attr_11,string attr_12,string attr_13,double attr_14,string attr_16,double attr_17,int attr_19,
/// vector<string> attr_20,double attr_21,double attr_22,double attr_23,string attr_24,int attr_25,double attr_26,string attr_27,
/// string attr_28,string attr_29,string attr_30,string attr_31,string attr_32,string attr_33,string attr_34,string attr_35,string attr_36,
/// bool attr_37,int attr_38,int attr_39,string attr_40,string attr_41,string attr_42,double attr_45,double attr_46,double attr_47,
...
/// \return nothing     
  ...
  void Stock_Write_Root_Metadata_Linear_Polar::writeRootMetadata(string outputFile,File &root_grp)
  {
      
/// <br /> Usage:
/// <br /> void Stock_Write_Root_Metadata_Linear_Polar::writeRootMetadata(string outputFile,File &root_grp)

/// \param outputFile this is the output file (dynamic spectrum file)
/// \param &root_grp Stock_Write_Root_Metadata_Linear_Polar_Part Object for catching stocked private attributes    
