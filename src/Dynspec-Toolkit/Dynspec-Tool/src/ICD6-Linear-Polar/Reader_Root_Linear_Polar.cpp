...
/// \file Reader_Root_Linear_Polar.cpp
///  \brief File C++ (associated to Reader_Root_Linear_Polar.h) for read ICD3 files and put in variables metadatas for the ICD6's Root Group  
///  \details  
/// <br /> Overview:
/// <br /> This function readRoot is described (programmed) here. It needs as parameter a Stock_Write_Root_Metadata_Linear_Polar_Part object. The readRoot function will read 
///  root metadatas and stock them in the Stock_Write_Root_Metadata_Linear_Polar_Part object as private attributes thanks to stockRootMetadata function.
///  These attributes will be written in the next step by writeRootMetadata function which is in the class 
///  Stock_Write_Root_Metadata_Linear_Polar_Part.h  and called at the end of this Reader_Root_Linear_Polar.cpp
...
using namespace std;
  ...
  Reader_Root_Linear_Polar::Reader_Root_Linear_Polar(){}	// constructor 
  Reader_Root_Linear_Polar::~Reader_Root_Linear_Polar(){}	// destructor
  
  
    
  void Reader_Root_Linear_Polar::readRoot(Stock_Write_Root_Metadata_Linear_Polar *rootMetadata,string ID,string filename, int nbBEAM)
    { 

/// <br /> Usage:
/// <br />   void Reader_Root_Linear_Polar::readRoot(string pathFile,string obsName,Stock_Write_Root_Metadata_Linear_Polar *rootMetadata,int obsNofSource,int obsNofFrequencyBand,int obsNofTiledDynspec, string SAPname, int SAPindex)

 
/// \param pathFileICD3 file to read
/// \param obsName observation ID
/// \param *rootMetadata Stock_Write_Root_Metadata_Linear_Polar_Part class object
...
/// \return nothing     
  ...
  Group Dynspec1(File1,"DYNSPEC_000");				// generate an object called Dynspec contains 1 Dynspec
...
//   Attribute<string> obj_PROJECT_TITLE(File1,"PROJECT_TITLE");
  ...
  string FILENAME("Dynspec_Linear_Polar_"+ID+".h5");
  ...
  string PROJECT_TITLE("Dynspec Linear Polarization");
  ...
  rootMetadata->stockRootMetadata(GROUPETYPE,FILENAME,FILEDATE,FILETYPE,TELESCOPE,PROJECT_ID,PROJECT_TITLE,PROJECT_PI,PROJECT_CO_I,   // attr10
    ...
    }  // end of the Reader_Root_Linear_Polar object
