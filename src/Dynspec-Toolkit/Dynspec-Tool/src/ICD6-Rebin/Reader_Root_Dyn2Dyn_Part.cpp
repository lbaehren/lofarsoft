...
/// \return nothing       
      ...
      for (int i=0; i<Nspectral;i++)
	{
      ...
      double OBSERVATION_FREQUENCY_MAX((AXIS_VALUE_WORLD_SPECTRAL[(AXIS_VALUE_WORLD_SPECTRAL.size())-1]));
      double OBSERVATION_FREQUENCY_MIN((AXIS_VALUE_WORLD_SPECTRAL[0]));
      double OBSERVATION_FREQUENCY_CENTER((OBSERVATION_FREQUENCY_MAX+OBSERVATION_FREQUENCY_MIN));	// conversion to Mhz
