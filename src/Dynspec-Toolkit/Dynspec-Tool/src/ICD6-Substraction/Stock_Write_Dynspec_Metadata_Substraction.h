#ifndef DEF_STOCK_WRITE_DYNSPEC_METADATA_SUBSTRACTION
#define DEF_STOCK_WRITE_DYNSPEC_METADATA_SUBSTRACTION
...
/// \class Stock_Write_Dynspec_Metadata_Substraction
...
{  
  ...
  public:
    ...
    Stock_Write_Dynspec_Metadata_Substraction();
    ~Stock_Write_Dynspec_Metadata_Substraction();
    ...
    void writeDynspecMetadata(Group &dynspec_grp,std::string outputFile,File &root_grp);
