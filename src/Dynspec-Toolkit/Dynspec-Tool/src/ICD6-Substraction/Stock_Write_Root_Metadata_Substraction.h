#ifndef DEF_STOCK_WRITE_ROOT_METADATA_SUBSTRACTION
#define DEF_STOCK_WRITE_ROOT_METADATA_SUBSTRACTION
...
/// \class Stock_Write_Root_Metadata_Substraction
...
{  
  ...
  public:
    ...
    Stock_Write_Root_Metadata_Substraction();
    ~Stock_Write_Root_Metadata_Substraction();
