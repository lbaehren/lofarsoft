...
/* $Id: lopestools.cc,v 1.3 2006/01/16 15:45:26 bahren Exp $ */

#include <lopestools.h>
#include <lopes/Functionals/MedianFilter.h>
...
Matrix<Complex> fft(int numdata, int tsize, float *files)
