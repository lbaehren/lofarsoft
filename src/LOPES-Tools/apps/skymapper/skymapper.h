...
/* $Id: skymapper.h,v 1.8 2006/10/31 18:40:46 bahren Exp $ */
...
/*!
  \brief Create am AIPS++ image from a shape and a coordinate system

  This function is about to test generation of an AIPS++ image tool,
  more or less imitating the process as taking place in the DOimage class.
 */
