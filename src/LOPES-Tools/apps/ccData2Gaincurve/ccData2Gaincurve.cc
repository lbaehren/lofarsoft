...
/* $Id: ccData2Gaincurve.cc,v 1.6 2006/10/31 18:35:44 bahren Exp $ */
...
/*!
  ...
  - [LOPES-Tools] DataCC - Storage for a set of cross-correlated data.
  - [LOPES-Tools] DataFrequency - Frequency domain settings of an observation.
  - [LOPES-Tools] Math - A collection of mathematical tools and functions. 
  - [LOPES-Tools] ObservationMeta - A class for storage of metadata to an ITS
                  experiment.
 */
			   ...
			   String division)
{
  ...
  try {
    ...
    //
    indices = LOPES::splitRange(range,nofBands,division);
  } catch (AipsError x) {
