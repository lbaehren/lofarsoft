...
#include <lopes/Functionals/StatisticsFilter.h>
...
public :
  ...
  */
  ...
  /*!
   ...
   \param phaseGradient        --       Phase gradient values due to the disimilar height of the bases of antennas, the 
                                        dimension of the matrix should be similar to the dimension of expectedPhases matrix.
    ...
    \param badnessWeight	--	default value given in the program is 0.5 but it can be changed by the user.
