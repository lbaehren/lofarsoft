...
/* $Id: ShapeletsModel1D.h,v 1.1 2005/07/15 10:10:37 bahren Exp $ */
...
class ShapeletsModel1D : public Shapelets1D {
  ...
  */
  vector<double> fx (const vector<double>& x);

  /*!
    \brief Fit model to data (image domain)
  */
  bool fit (const vector<double>& data);
  
  /*!
    \brief Fit model to data (uv domain)
  */
  bool fit (const vector<complex<double> >& data);
