  ...
  public:
    ...
    */
    ...
    /*!
      ...
      This function gets the blocksize (in bits) of the PeakSearch object. The
      blocksize identifies the interval over which the average and standard
      deviation are to be calculated. A blocksize of \f$k\f$ means \f$2^k\f$
      samples are included in an average.
    */
    uint& blocksize() {
      return blocksize_;
    }
    ...
    */
    ...
    /*!
      ...
      This function gets the window (in samples) of the PeakSearch object. The
      window identifies the maximum time difference between the first and last
      peak of a possible correlation.
    */
