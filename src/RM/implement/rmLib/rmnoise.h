...
class rmnoise
  ...
  public:
    ...
    rmnoise (unsigned int x1=123456789, unsigned int y1=362436069,
...
//      planck_assert (sizeof(unsigned int)==4, "wrong integer size for RNG");
    ...
    //
    //***************************************************************
    void createNoiseVector(std::vector<double> &noise, double sigma, const std::string &type, const double alpha=0);
    void createNoiseVector(std::vector<std::complex<double> > &noise, double sigma, const std::string &type, const double alpha=0);
    void createNoiseVector(itpp::cvec &noise, double sigma, const std::string &type, const double alpha=0);
    void addNoise(std::vector<double> &signal, double rms, std::string &type, double alpha=0);
    void addNoise(std::vector<std::complex<double> > &signal, double rms, std::string &type, double alpha=0);
    void addNoise(itpp::cvec &signal, double rms, std::string &type, double alpha=0);
};
