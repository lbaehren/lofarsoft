...
{	
  ...
  {
  		this->lambdaSquareds=freqToLambdaSq(frequencies); 			// Convert frequencies to lambda squared
  }
...
//	polarizedInt=forwardFourier(lambdaSquareds, faradayLOS, faradayDepths, weights);
