...
*/
void writeLogging (PagedImage<Float> image,
		   int method,
		   int useClean)
{
...
complex<double> testComplexPerform (vector<complex<double> > &v1,
