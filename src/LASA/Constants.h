...
#define Spy_Event	5//20	//Spying every 'Spy_Event' total events from all LASAs
...
#define Spy_Delay	10	//Spying 'Spy_Event' events from 'xxxth' event upto the last 'Spy_Delay'th event
#define Coin_Window	400	//Coincidence time in nanosecs
