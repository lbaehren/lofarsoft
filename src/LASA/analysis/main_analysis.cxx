...
//! Event data structure stored in the ROOT file
struct EVENT_DATA
{
  //! Detector number
  unsigned int detector ;
  //! YearMonthDay (E.g: 20090325 for 25/03/2009)
  unsigned int YMD ;
  //! Event time stamp in secs since the Epoch (00:00:00 UTC, Jan 1 1970)
  unsigned int GPS_time_stamp ;
  unsigned int CTD ;	
  //! An apprx. value
  unsigned int nsec ;
  //! Trigger pattern
  unsigned int Trigg_pattern ;
  //! Total counts in a signal
  unsigned int Total_counts;
  //! Pulse height of a signal
...
//! Creating subdirectories for the "Detectors"
void Create_ROOT_SubDirectories1 (int det)
{
  char det_no[30] ;
