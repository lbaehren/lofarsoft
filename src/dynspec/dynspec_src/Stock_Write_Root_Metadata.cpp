...
using namespace std;
  ...
  Stock_Write_Root_Metadata::Stock_Write_Root_Metadata(){}
  Stock_Write_Root_Metadata::~Stock_Write_Root_Metadata(){}


  void Stock_Write_Root_Metadata::stockRootMetadata(string attr_1,string attr_2,string attr_3,string attr_4,string attr_5,string attr_6,string attr_7,string attr_8,string attr_9,string attr_10,
				       string attr_11,string attr_12,string attr_13,double attr_14,string attr_15,string attr_16,double attr_17,string attr_18,int attr_19,
				       ...
				       string attr_28,string attr_29,vector<string> attr_30,string attr_31,string attr_32,string attr_33,string attr_34,string attr_35,string attr_36,
				       ...
				       vector<string> attr_48,vector<string> attr_49,double attr_50,string attr_51,int attr_52,double attr_53,string attr_54,double attr_55,string attr_56,double attr_57,string attr_58,
				       ...
				       vector<double> attr_67,vector<double> attr_68) 
 {
    ...
    m_size_attr_30= attr_30.size();
    m_attr_30.resize(m_size_attr_30);
    for (int i=0;i< attr_30.size();i++)
    {m_attr_30[i] = attr_30[i];}      
  ...
  void Stock_Write_Root_Metadata::writeRootMetadata(string outputFile,File &root_grp)
  {
      ...
      Attribute<string> attr_06(root_grp, "OBSERVER"); 
      ...
      Attribute<string> attr_15(root_grp, "OBSERVATION_START_TAI");
      Attribute<string> attr_16(root_grp, "OBSERVATION_END_UTC");
      Attribute<double> attr_17(root_grp, "OBSERVATION_END_MJD");
      Attribute<string> attr_18(root_grp, "OBSERVATION_END_TAI");
      ...
      Attribute<vector<string> > attr_30(root_grp, "TARGET");      
      ...
      Attribute<string> attr_34(root_grp, "ICD_NUMBER");
      Attribute<string> attr_35(root_grp, "ICD_VERSION");
      ...
      Attribute<double> attr_50(root_grp, "CLOCK_RATE");
      Attribute<string> attr_51(root_grp, "CLOCK_RATE_UNIT");      
      ...
      attr_15.value = m_attr_15;
      attr_16.value = m_attr_16;
      attr_17.value = m_attr_17;
      attr_18.value = m_attr_18;
      ...
      attr_50.value = m_attr_50;
      attr_51.value = m_attr_51;
