#ifndef DEF_STOCK_WRITE_ROOT_METADATA
#define DEF_STOCK_WRITE_ROOT_METADATA
...
class Stock_Write_Root_Metadata
{  
  // Public Methods
  public:
    ...
    void stockRootMetadata(std::string attr_1,std::string attr_2,std::string attr_3,std::string attr_4,std::string attr_5,std::string attr_6,std::string attr_7,std::string attr_8,std::string attr_9,std::string attr_10,
			 std::string attr_11,std::string attr_12,std::string attr_13,double attr_14,std::string attr_15,std::string attr_16,double attr_17,std::string attr_18,int attr_19,
			 ...
			 std::string attr_28,std::string attr_29,std::vector<std::string> attr_30,std::string attr_31,std::string attr_32,std::string attr_33,std::string attr_34,std::string attr_35,std::string attr_36,
			 ...
			 std::vector<std::string> attr_48,std::vector<std::string> attr_49,double attr_50,std::string attr_51,int attr_52,double attr_53,std::string attr_54,double attr_55,std::string attr_56,double attr_57,std::string attr_58,
  ...
  private:
    ...
    double m_attr_14;
    std::string m_attr_15;
    std::string m_attr_16;
    double m_attr_17;
    std::string m_attr_18;
    int m_attr_19;  
    ...
    int m_size_attr_30;
    std::vector<std::string> m_attr_30;
