...
/// \file Reader_Root_Part.cpp
///  \brief File C++ (associated to Reader_Root_Part.h) for read ICD3 files and put in variables metadatas for the ICD6's Root Group  
///  \details  
/// <br /> Overview:
...
///  Stock_Write_Root_Metadata_Part.h  and called at the end of this Reader_Root_Part.cpp
...
using namespace std;
  ...
  Reader_Root_Part::Reader_Root_Part(){}	// constructor 
  Reader_Root_Part::~Reader_Root_Part(){}	// destructor
  

    
  void Reader_Root_Part::readRoot(string pathFile,string obsName,Stock_Write_Root_Metadata_Part *rootMetadata,int obsNofBeam, string SAPname, int SAPindex,float timeMinSelect,float timeMaxSelect,float timeRebin,float frequencyMin,float frequencyMax,float frequencyRebin)

  { 
    
/// <br /> Usage:
/// <br /> void Reader_Root_Part::readRoot(string pathFile,string obsName,Stock_Write_Root_Metadata_Part *rootMetadata,int obsNofSource,int obsNofBeam,int obsNofFrequencyBand,int obsNofTiledDynspec, string SAPname, int SAPindex,float timeMinSelect,float timeMaxSelect,float timeRebin,float frequencyMin,float frequencyMax,float frequencyRebin)
