...
{    
  ...
  void readRoot(std::string pathFile,std::string obsName,Stock_Write_Root_Metadata_Part *rootMetadata,int obsNofBeam, std::string SAPname, int SAPindex,float timeMinSelect,float timeMaxSelect,float timeRebin,float frequencyMin,float frequencyMax,float frequencyRebin);
