...
/// \class Stock_Write_Dynspec_Metadata_Quick
...
{  
  ...
  public:
    ...
    Stock_Write_Dynspec_Metadata_Quick();
    ~Stock_Write_Dynspec_Metadata_Quick();
    ...
    void writeDynspecMetadata(Group &dynspec_grp,std::string obsName,std::string pathFile,std::string outputFile,File &root_grp,int i,int j,int k,int l,int q,int obsNofStockes,std::vector<std::string> stokesComponent);
