...
/// \file Reader_Root_Quick.cpp
///  \brief File C++ (associated to Reader_Root_Quick.h) for read ICD3 files and put in variables metadatas for the ICD6's Root Group  
///  \details  
/// <br /> Overview:
/// <br /> This function readRoot is described (programmed) here. It needs as parameter a Stock_Write_Root_Metadata_Quick object. The readRoot function will read 
///  root metadatas and stock them in the Stock_Write_Root_Metadata_Quick object as private attributes thanks to stockRootMetadata function.
///  These attributes will be written in the next step by writeRootMetadata function which is in the class 
///  Stock_Write_Root_Metadata_Quick.h  and called at the end of this Reader_Root_Quick.cpp
...
using namespace std;
  ...
  Reader_Root_Quick::Reader_Root_Quick(){}	// constructor 
  Reader_Root_Quick::~Reader_Root_Quick(){}	// destructor
  

    
  void Reader_Root_Quick::readRoot(string pathFile,string obsName,Stock_Write_Root_Metadata_Quick *rootMetadata,int obsNofBeam, string SAPname, int SAPindex,float timeMinSelect,float timeMaxSelect,float timeRebin,float frequencyMin,float frequencyMax,float frequencyRebin)

  { 
    
/// <br /> Usage:
/// <br /> void Reader_Root_Quick::readRoot(string pathFile,string obsName,Stock_Write_Root_Metadata_Quick *rootMetadata,int obsNofSource,int obsNofBeam,int obsNofFrequencyBand,int obsNofTiledDynspec, string SAPname, int SAPindex,float timeMinSelect,float timeMaxSelect,float timeRebin,float frequencyMin,float frequencyMax,float frequencyRebin)

 
/// \param pathFileICD3 file to read
/// \param obsName observation ID
/// \param *rootMetadata Stock_Write_Root_Metadata_Quick class object
