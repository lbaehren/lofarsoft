...
/// \file Stock_Write_Dynspec_Data_Quick.cpp
///  \brief File C++ (associated to Stock_Write_Dynspec_Data_Quick.h) for stocking data parameters, processing the (select or rebin) and write data Matrix in the ICD6's Dynspec Groups 
///  \details  
/// <br /> Overview:
...
using namespace std;
  ...
  Stock_Write_Dynspec_Data_Quick::Stock_Write_Dynspec_Data_Quick(){}
  Stock_Write_Dynspec_Data_Quick::~Stock_Write_Dynspec_Data_Quick(){}
  
  void Stock_Write_Dynspec_Data_Quick::stockDynspecData(int Ntime,int Nspectral,  int NtimeReal, int NspectralReal)
  { 
  /// <br /> Usage:
  /// <br />   void Stock_Write_Dynspec_Data_Quick::stockDynspecData(int Ntime,int Nspectral,  int NtimeReal, int NspectralReal)
