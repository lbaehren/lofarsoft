...
fn2005			eventlist-2005.txt
fn2006			eventlist-2006.txt
fn2007			eventlist-2007.txt
fn2008			eventlist-2008.txt
fn2009			eventlist-2009.txt
...
int main(int argc, char* argv[])
{
 // try {
  ...
  string cut_str(""), fn2005(""), fn2006(""), fn2007(""), fn2008(""), fn2009(""), namebase="REASinputList";
...
//   fstream fin;
  ...
  double alfa=15.23*(TMath::Pi()/180.); //in grad anlge between the 2 ref.system
  double E,Eg=0.;
  ...
  for (int i=0; i<nentries; i++) {
    ...
    Xlopes=Xc*cos(alfa)+Yc*sin(alfa); //East
    //cout<<"Xlopes    "<<Xlopes<<endl;
    Ylopes=-Xc*TMath::Sin(alfa)+Xc*TMath::Cos(alfa); //North
    Xlopesg=Xcg*TMath::Cos(alfa)+Ycg*TMath::Sin(alfa); //East
    Ylopesg=-Xcg*TMath::Sin(alfa)+Xcg*TMath::Cos(alfa); //North
