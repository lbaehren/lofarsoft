...
//Skipped Stopwatches here
  ...
  sprintf(inFileName[0], "/mnt/lofar/raw_data_23Mar/storage05/MOON22.000019.dada");
  sprintf(inFileName[1], "/mnt/lofar/raw_data_23Mar/storage04/MOON22.000019.dada");
  sprintf(inFileName[2], "/mnt/lofar/raw_data_23Mar/storage03/MOON22.000019.dada");
  sprintf(inFileName[3], "/mnt/lofar/raw_data_23Mar/storage02/MOON22.000019.dada");
