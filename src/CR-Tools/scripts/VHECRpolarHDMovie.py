...
def usage():
    print "Usage: python VHECRpolarHDMovie <filename> [--name=stationName, --antennamode=antennaMode, --channels=coincidentChannels]"
    print " "
...
print 'Calling ImageMagick''s mogrify (convert to PPM), then ppm2y4m, pipe through mpeg2enc. The latter two are from the MJPEG package'
...
#call(['mogrify', '-crop', '1080x1080+180+180', '-format', 'ppm', '*.png'])
#print 'Calling mpeg2vidcodec''s mpeg2encode to make a .mpg MPEG-1 animation out of it'
#call(['mpeg2encode', 'MPEG-2HD.par', 'VHECRanimation.m2v'])
print 'Done!'
