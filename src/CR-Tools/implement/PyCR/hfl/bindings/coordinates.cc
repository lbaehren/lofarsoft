...
namespace hfl
{
    ...
    {
      return hfl::coordinates::pixel2World(hfl::numpyBeginPtr<double>(world), hfl::numpyEndPtr<double>(world), hfl::numpyBeginPtr<double>(pixel), hfl::numpyEndPtr<double>(pixel), refcode, projection, refLong, refLat, incLong, incLat, refX, refY);
    }
