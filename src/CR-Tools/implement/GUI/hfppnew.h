...
#define HFPP_GET_FUNC_TYPE_VALUE BOOST_PP_SEQ_ELEM(0,HFPP_FUNCDEF)
...
//#define HFPP_GET_PAR_BASETYPE(N) BOOST_PP_IF(HFPP_PAR_TYPE_IS_TEMPLATED(N),HFPP_GET_TEMPLATE_PARAMETER_NAME(HFPP_GET_PAR_BASETYPE_VAL(N)),HFPP_GET_PAR_BASETYPE_VAL(N))
//#define HFPP_GET_PAR_BASETYPE(N) BOOST_PP_IF(HFPP_PAR_TYPE_IS_TEMPLATED_##N,HFPP_GET_TEMPLATE_PARAMETER_NAME(HFPP_GET_PAR_BASETYPE_VAL(N)),HFPP_GET_PAR_BASETYPE_VAL(N))
...
#define HFPP_GET_PAR_DECLARATION_DIM1STL(TYPE) STLVector<TYPE>

#define HFPP_GET_PAR_DECLARATION_DIM0CASA(TYPE) TYPE
#define HFPP_GET_PAR_DECLARATION_DIM1CASA(TYPE) CASAVector<TYPE>
//------------------------------------------------------------------------------
...
#define HFPP_MAKE_WRAPPERS_VEC_CC(WRAPPERTYPE) \
  template <class T> inline HFPP_GET_FUNC_BASETYPE HFPP_GET_FUNC_NAME(HFPP_GET_PARLIST_DECLARATION(WRAPPERTYPE)) { _H_NL_\
