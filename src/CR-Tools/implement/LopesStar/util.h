...
//! struct of the reconstructed event tree
  struct RecEvent{
     ...
     float AzimuthGrande; 			/*!<Azimuth angle from Grande*/
     float ZenithGrande;			/*!<Zenith angle from Grande*/
     ...
     char timestamp[Max_Time_t];		/*!<GPS timestamp*/
     float PulseLength1Third[Max_NoCh]; 	/*!<pulse length at 1 third of the max height in units of ns*/
     float PulseLengthFWHM[Max_NoCh];		/*!<pulse length at the half heigth in units of ns*/
     ...
     float SNR[Max_NoCh];			/*!<signal to noise ratio*/
     float CoreDistance[Max_NoCh];		/*!<distance from the antenna to the shower core (shower coordinate system) in m*/
     ...
     float ShowerCoreXGrande;			/*!<reconstructed shower core position by Grande in m*/
     float ShowerCoreYGrande;			/*!<reconstructed shower core position by Grande in m*/
