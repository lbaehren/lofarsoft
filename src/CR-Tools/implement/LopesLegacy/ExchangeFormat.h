...
#ifndef _EXCHANGEFORMAT_H_
#define _EXCHANGEFORMAT_H_
...
namespace CR {  // Namespace CR -- begin
  ...
  */
  ...
  public:
    ...
    */
    bool flag(const uInt fl)      {return ((format_p & fl) == fl);}
    ...
    */
    void setFlag(const uInt fl, bool on);
    ...
    /*!
      ...
      will set both the EF_isScalar and EF_isComplex flags.
    */
    void setFlag(const uInt fl)   {setFlag(fl, true);}
    ...
    */
    void clearFlag(const uInt fl) {setFlag(fl, false);}
    ...
    */
    ...
    /*!
      ...
      the different flags.
    */
    bool operator==(const ExchangeFormat &f) {return compare(f);}
