...
namespace CR {  //  Namespace CR -- begin
  ...
  //__________________________________________________________________ LopesEvent
  ...
  void LopesEvent::init ()
  {
    ...
    DataReader::setBlocksize (length_);
  ...
  {  
    ...
    evType() = (EvType)tmp;
    handle->read((char*)&blocksize_p, sizeof(int));
				   ...
				   int* handle_end)
  {
    ...
    handle->write((char*)&blocksize_p, sizeof(int)) ;
  ...
  {
    os << "[LopesEvent] Summary of the internal parameters"         << std::endl;
  ...
  //____________________________________________________________________ setStreams
  ...
  Bool LopesEvent::setStreams ()
  {
    ...
    */
    ...
    std::cout << "[LopesEvent::setStreams]" << std::endl;
    std::cout << "-- blocksize [samples] = " << nofSamples          << std::endl;
    std::cout << "-- antennas            = " << antennas            << std::endl;
    std::cout << "-- FFT length          = " << fftLength           << std::endl;
    std::cout << "-- shape(adc2voltage)  = " << adc2voltage.shape() << std::endl;
    std::cout << "-- shape(fft2calfft)   = " << fft2calfft.shape()  << std::endl;
#endif
