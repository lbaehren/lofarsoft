...
hAllContainerMethods = ["hFill","hSet","hFind","hFlip","hCopy","hSort","hZipper","hReadFileBinary","hWriteFileBinary","hWriteFileBinaryAppend","hRedistribute","hPPrint","hPrettyString","hReadFileText","hWriteFileText"]
