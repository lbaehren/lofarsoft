# -*- coding: utf-8 -*-
#
# Pycrtools documentation build configuration file, created by
...
extensions = ['sphinx.ext.autodoc', 'sphinx.ext.todo', 'sphinx.ext.pngmath', 'sphinx.ext.doctest']
...
htmlhelp_basename = 'Pycrtoolsdoc'
