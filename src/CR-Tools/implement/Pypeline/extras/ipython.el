...
;;Slightly modified for use with pycrtools by H. Falcke, May, 2010
;;Installation for Emacs/Aquaemacs on Mac:
;;
;;Copy this file to ~/Library/Preferences/Emacs/ipython.el
...
(setq py-python-command-args '("-ppycr"))
;;
;;
