...
namespace CR {  // Namespace CR -- begin
  ...
  void inverseFFT::copy (inverseFFT const &other)
  {
    ...
    f107_p            = other.f107_p;
    longitude_p       = other.longitude_p;
    latitude_p        = other.latitude_p;
    altitude_p        = other.altitude_p;
  }
  ...
  void inverseFFT::summary (std::ostream &os)
  {
    os << "[inverseFFT] Summary of object properties." << std::endl;
    os << "-- Data blocksize               = " << dataBlocksize_p << std::endl;
    os << "-- 10.7 cm flux on previous day = " << f107_p          << std::endl;
    os << "-- Geographic longitude         = " << longitude_p     << std::endl;
    os << "-- Geographic latitude          = " << latitude_p      << std::endl;
    os << "-- Altitude                     = " << altitude_p      << std::endl;
  ...
  {				     				     
    ...
    try {
      Double arguement  = cos(latitude*pi/180.) ;
      Double derivative = diff_legendre(latitude, degree, order) ;
  ...
  {				     				     
    ...
    try {
      ...
      Double as_legendre = legendre(latitude, 2, 0) ;
  ...
  {				     				     
	...
	break;
      default:
	std::cerr << "[inverseFFT::symmetrical] Unsupported function!" << std::endl;
	break;
      }
  ...
  {				     				     
	...
	break;
      default:
	std::cerr << "[inverseFFT::asymmetrical] Unsupported function!" << std::endl;
	break;
      }
			      ...
			      const Double& latitude ) 
  {
    ...
    try {
      ...
      Double asl_11 = legendre(latitude, 1, 1) ;
      Double asl_31 = legendre(latitude, 3, 1) ;
      Double asl_51 = legendre(latitude, 5, 1) ;
      Double asl_21 = legendre(latitude, 2, 1) ;
	...
	break;
      default:
	std::cerr << "[inverseFFT::diurnal] Unsupported function!" << std::endl;
	break;
      }
  ...
  {				     				     
    ...
    try {
      ...
      Double asl_22 = legendre(latitude, 2, 2) ;
      Double asl_42 = legendre(latitude, 4, 2) ;
      Double asl_32 = legendre(latitude, 3, 2) ;
				  ...
				  
  {
    ...
    try {
      ...
      Double asl_33 = legendre(latitude, 3, 3) ;
      Double asl_43 = legendre(latitude, 4, 3) ;
      Double asl_63 = legendre(latitude, 6, 3) ;
                               ...
                               const Double& latitude ) 
  {
    ...
    try {
      ...
      Double asl_30 = legendre(latitude, 3, 0) ;
      Double asl_31 = legendre(latitude, 3, 1) ;
      Double asl_50 = legendre(latitude, 5, 0) ;
      Double asl_51 = legendre(latitude, 5, 1) ;
  ...
  {				     				     
    ...
    try {
      ...
      Double asl_21 = legendre(latitude, 2, 1) ;
      Double asl_41 = legendre(latitude, 4, 1) ;
      Double asl_61 = legendre(latitude, 6, 1) ;
      Double asl_11 = legendre(latitude, 1, 1) ;
      Double asl_31 = legendre(latitude, 3, 1) ;
      Double asl_51 = legendre(latitude, 5, 1) ;
