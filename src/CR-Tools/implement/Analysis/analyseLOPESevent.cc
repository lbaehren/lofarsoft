...
namespace CR { // Namespace CR -- begin
  ...
  Bool analyseLOPESevent::SetupEvent(String evname, 
	...
	upsampler_p->timeValues(Times,upsampler_p->block(),true);
	...
	beamPipe_p =  pipeline_p;
      ...
      beamformDR_p->timeValues(Times,beamformDR_p->block(),true);
...
#define CCstop 0.5
  ...
  Double analyseLOPESevent::getHeight (Double az,
	...
	*centerp = ergrec.asDouble("CCcenter");
	...
	goodfit=False;
	beamformDR_p->timeValues(pb,beamformDR_p->block(),true);
