...
namespace CR { // Namespace CR -- begin
    ...
    
  {
	...
	sum_tied_array = sum_tied_array +stationbeam*sin(declination)*abs(power_gain) ;
      }
      
      integral_value = real(sum_tied_array);
