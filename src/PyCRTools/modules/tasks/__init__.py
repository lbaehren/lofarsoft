...
task_modules = ["averagespectrum","dynamicspectrum","fitbaseline","imager","crimager","beamformer","beamformer2","pulsecal","ldf","plotfootprint","cabledelays","antennaresponse","eventstatistics","stationbeamformer","pulseenvelope"]
