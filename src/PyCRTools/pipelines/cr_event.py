...
#    full_filename=os.path.expandvars(os.path.expanduser(filename))
    ...
    outputdir_with_subdirectories=os.path.join(outputdir_expanded,projectname+"-"+time_stamp,"pol"+str(polarization),station_name)
    outfilename=rootfilename+"-pol"+str(polarization)
    ...
    pulse=trerun("LocatePulseTrain","",timeseries_data2,pardict=par,doplot=Pause.doplot,search_window=search_window)
