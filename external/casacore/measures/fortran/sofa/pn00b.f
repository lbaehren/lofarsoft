...
*  supporting classical, equinox-based, use_directly and CEO-based
*  use_indirectly.
*
...
*
*     The JD method is the most natural and convenient to use_in
...
*     at the cost of increased computation, use_the iau_PN00A routine.
*     For the utmost accuracy, use_the iau_PN00 routine, where the
