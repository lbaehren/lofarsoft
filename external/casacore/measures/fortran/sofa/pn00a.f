...
*  supporting both classical equinox-based use_(directly) and CEO-based
*  use_(indirectly).
*
...
*     the utmost accuracy, use_the iau_PN00 routine, where the nutation
*     components are caller-specified.  For faster but slightly less
*     accurate results, use_the iau_PN00B routine.
*
