*=======================================================================
*     $Id: lawson.f,v 19.1 2004/08/25 02:28:08 cvsmgr Exp $
*-----------------------------------------------------------------------
C
...
C                      USE_THE FOLLOWING RETURN IF UNSUCCESSFUL IN NNLS.
      IF (MODE.NE.1) RETURN
      IF (RNORM) 130,130,50
   50 FAC=ONE
      IW=IY-1
...
C
C          OTHERWISE USE_ALPHA WHICH WILL BE BETWEEN 0. AND 1. TO
...
C        BE BECAUSE_OF THE WAY ALPHA WAS DETERMINED.
