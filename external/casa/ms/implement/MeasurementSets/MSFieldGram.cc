...
//#
//# $Id: MSFieldGram.cc,v 1.7 2006/09/28 07:07:49 sbhatnag Exp $
...
#include <ms/MeasurementSets/MSFieldGram.ycc>  // flex output
#include <ms/MeasurementSets/MSFieldGram.lcc>  // bison output
