...
//#
//# $Id: MSTimeGram.cc,v 19.9 2006/09/28 07:21:18 sbhatnag Exp $
...
#include <ms/MeasurementSets/MSTimeGram.ycc>                  // flex output
#define yy_scan_chars yy_scan_chars_MSTimeGram
#include <ms/MeasurementSets/MSTimeGram.lcc>                  // bison output
