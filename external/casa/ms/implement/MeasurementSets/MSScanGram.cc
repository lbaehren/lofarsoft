...
//#
//# $Id: MSScanGram.cc,v 19.1 2005/06/29 22:41:25 ddebonis Exp $
...
#include <ms/MeasurementSets/MSScanGram.ycc>  // flex output
#include <ms/MeasurementSets/MSScanGram.lcc>  // bison output
