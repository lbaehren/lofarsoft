...
//#
//# $Id: MSSpwGram.cc,v 1.6 2006/09/28 07:11:05 sbhatnag Exp $
...
#include <ms/MeasurementSets/MSSpwGram.ycc>                  // flex output
#include <ms/MeasurementSets/MSSpwGram.lcc>                  // bison output
