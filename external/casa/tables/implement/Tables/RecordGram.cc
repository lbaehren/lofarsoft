...
//#
//# $Id: RecordGram.cc,v 19.7 2006/11/10 01:16:01 gvandiep Exp $
...
#include <tables/Tables/RecordGram.ycc>                  // flex output
#include <tables/Tables/RecordGram.lcc>                  // bison output
