...
class VisualAction : public Action
{
public:
	...
	{
		for_each(this, node, node->visualModel, &VisualAction::processVisualModel);
...
class VisualDrawAction : public VisualAction
{
public:
	virtual Result processNodeTopDown(GNode* node);
...
class VisualUpdateAction : public VisualAction
{
public:
	virtual void processVisualModel(GNode*, core::VisualModel* vm);
};

class VisualInitTexturesAction : public VisualAction
{
public:
	virtual void processVisualModel(GNode*, core::VisualModel* vm);
};

class VisualComputeBBoxAction : public VisualAction
{
public:
	double minBBox[3];
	double maxBBox[3];
