...
*******************************************************************************/
//
// C++ Interface: MechanicalComputeEnergyAction
//
// Description: 
//
//
...
*/
class MechanicalComputeEnergyAction : public sofa::simulation::tree::MechanicalAction
{
    double m_kineticEnergy;
    double m_potentialEnergy;
    
    public:
    MechanicalComputeEnergyAction();
