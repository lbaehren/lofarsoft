...
*******************************************************************************/
//
// C++ Interface: PropagateEventAction
//
// Description: 
//
//
...
/**
Action used to propagate an event in the the data structure.
Propagation is done top-down until the event is handled.

	@author The SOFA team </www.sofa-framework.org>
*/
class PropagateEventAction : public sofa::simulation::tree::Action
{
public:
    PropagateEventAction(sofa::core::objectmodel::Event* e);

    ~PropagateEventAction();
    
    Action::Result processNodeTopDown(GNode* node);
