...
class ActionScheduler : public virtual core::objectmodel::BaseObject
{
public:
	virtual ~ActionScheduler() {}
	
	virtual void executeAction(GNode* node, Action* act) = 0;
...
protected:
	...
	void doExecuteAction(GNode* node, Action* act);
};
