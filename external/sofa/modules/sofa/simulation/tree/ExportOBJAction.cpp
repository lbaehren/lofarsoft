...
ExportOBJAction::ExportOBJAction(std::ostream* out,std::ostream* mtl)
: out(out), mtl(mtl), vindex(0), nindex(0), tindex(0)
{
}

ExportOBJAction::~ExportOBJAction()
{
}

void ExportOBJAction::processVisualModel(GNode* node, core::VisualModel* vm)
{
...
Action::Result ExportOBJAction::processNodeTopDown(GNode* node)
{
	for_each(this, node, node->visualModel, &ExportOBJAction::processVisualModel);
	
	return RESULT_CONTINUE;
}

void ExportOBJAction::processNodeBottomUp(GNode* /*node*/)
{
}
