...
void CreateTGrande (TChain *TGrande,
		    struct h3 *h3,
		    bool Grande_orig) {
...
void CreateTRecEvent (TChain *TRecEvent,
		      struct RecEvent *RecEvent) {
   ...
   TRecEvent->SetBranchAddress("Azimuth1ThirdFit",&RecEvent->Azimuth1ThirdFit);
   TRecEvent->SetBranchAddress("Azimuth1ThirdFit_err",&RecEvent->Azimuth1ThirdFit_err);
   TRecEvent->SetBranchAddress("Zenith1ThirdFit",&RecEvent->Zenith1ThirdFit);
   TRecEvent->SetBranchAddress("Zenith1ThirdFit_err",&RecEvent->Zenith1ThirdFit_err);
   TRecEvent->SetBranchAddress("AzimuthFWHMFit",&RecEvent->AzimuthFWHMFit);
   TRecEvent->SetBranchAddress("AzimuthFWHMFit_err",&RecEvent->AzimuthFWHMFit_err);
   TRecEvent->SetBranchAddress("ZenithFWHMFit",&RecEvent->ZenithFWHMFit);
   TRecEvent->SetBranchAddress("ZenithFWHMFit_err",&RecEvent->ZenithFWHMFit_err);
   ...
   TRecEvent->SetBranchAddress("PulseLength1ThirdFit",&RecEvent->PulseLength1ThirdFit);
   TRecEvent->SetBranchAddress("PulseLengthFWHMFit",&RecEvent->PulseLengthFWHMFit);
   TRecEvent->SetBranchAddress("PulsePos1ThirdFit",&RecEvent->PulsePos1ThirdFit);
   TRecEvent->SetBranchAddress("PulsePosFWHMFit",&RecEvent->PulsePosFWHMFit);
   ...
   TRecEvent->SetBranchAddress("DistanceShowerAxis",&RecEvent->DistanceShowerAxis);
   TRecEvent->SetBranchAddress("DistanceShowerAxisErr",&RecEvent->DistanceShowerAxisErr);
   ...
   TRecEvent->SetBranchAddress("FieldStrengthChannelFit",&RecEvent->FieldStrengthChannelFit);
   TRecEvent->SetBranchAddress("FieldStrengthAntennaFit",&RecEvent->FieldStrengthAntennaFit);
   
   TRecEvent->SetBranchAddress("ChannelErrFieldStrengthFit",&RecEvent->ChannelErrFieldStrengthFit);   
   TRecEvent->SetBranchAddress("ChannelErrFieldStrength",&RecEvent->ChannelErrFieldStrength);   
   TRecEvent->SetBranchAddress("ChannelErrBackground",&RecEvent->ChannelErrBackground);   
   
   TRecEvent->SetBranchAddress("LDFSlope",&RecEvent->LDFSlope);   
}
...
void SetStruct2Zero(struct RecEvent *RecEvent){
   ...
   RecEvent->Azimuth1ThirdFit = 0;
   RecEvent->Azimuth1ThirdFit_err = 0;
   RecEvent->Zenith1ThirdFit = 0;
   RecEvent->Zenith1ThirdFit_err = 0;
   RecEvent->AzimuthFWHMFit = 0;
   RecEvent->AzimuthFWHMFit_err = 0;
   RecEvent->ZenithFWHMFit = 0;
   RecEvent->ZenithFWHMFit_err = 0;
   ...
   RecEvent->PulseLength1ThirdFit[0] = 0;
   RecEvent->PulseLengthFWHMFit[0] = 0;
   RecEvent->PulsePos1ThirdFit[0] = 0;
   RecEvent->PulsePosFWHMFit[0] = 0;

   RecEvent->DistanceShowerAxis[0] = 0;
   RecEvent->DistanceShowerAxisErr[0] = 0;
   ...
   RecEvent->FieldStrengthChannelFit[0] = 0;
   RecEvent->FieldStrengthAntennaFit[0] = 0;
   
   RecEvent->ChannelErrFieldStrengthFit[0] = 0;
   RecEvent->ChannelErrFieldStrength[0] = 0;
   RecEvent->ChannelErrBackground[0] = 0;
...
void CreateTChain(TChain *Tevent,
		  char *FileName){
...
float GetSigma(int window_size, float *trace){
  ...
  for(int i=0; i<window_size; i++){
    sum += trace[i];
    sumsum += trace[i]*trace[i];
  }
  
  sigma = sqrt( (window_size * sumsum - sum*sum) / (window_size * (window_size -1)));
...
float GetMean(int window_size, float *trace){
  ...
  for(int i=0; i<window_size; i++) mean += trace[i];
  mean /= window_size;
...
float GetRMS(int window_size, float *trace){
  ...
  rms = sqrt( sumsum / (float)(window_size) );
