...
*   $Id: tpih2.c,v 4.2 2005/09/23 03:09:34 cal103 Exp $
*=============================================================================
*
...

{
   ...
   int  i, ic, gcode[2], naxis[2], ncards, nreject, nwcs, relax, status;
   float  blc[2], trc[2];
   ...
   relax = WCSHDR_all;
   if (status = wcspih(header, ncards, relax, 3, &nreject, &nwcs, &wcs)) {
