...
*   $Id: twcs.f,v 4.2 2005/09/21 13:37:53 cal103 Exp $
*=======================================================================
...
*     Set PVi_m cards for the longitude axis (I = 4).  For test
...
*     PVi_m cards for the latitude axis (I = 2).
     ...
     :             /2, 1, -30D0/
      ...
      DOUBLE PRECISION DLAT, DLNG, FREQ, IMG(NELEM,0:360), LAT1, LNG1,
     :          PHI(0:360), PIXEL1(NELEM,0:360), PIXEL2(NELEM,0:360),
     :          R, RESID, RESMAX, THETA(0:360), TIME,
     :          WORLD1(NELEM,0:360), WORLD2(NELEM,0:360)
